...
def help():
	print("usage: swrite [<options>] <device> [<input>]", file=stderr)
	print("   -u <path>   serial device to write to", file=stderr)
	...
	print("   -w <num>    delay before writing (seconds)", file=stderr)
	print("   -l <int>    number of bytes to write", file=stderr)
